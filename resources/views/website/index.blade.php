...
@section('content')
    ...
    <!-- Announcements -->
    <section id="announcements" class="wow fadeInUp text-right">
        <div class="container">
            <div class="section-header">
                <h2 class="">اعلامیه ها</h2>
            </div>
                        ...
                        <div class="card text-right">
                            ...
                            <div class="">
                                ...
                                <div class="m-2 text-right">
                                    <a href="{{ route('website.announcement', $announcement->title) }}" class="font-weight-bold">{{ $announcement->title }}</a>
                                    <p>{!! str()->limit($announcement->body, 100, '...') !!}</p>
                                </div>
                            </div>
                            <!-- Footer -->
                            <div class="card-footer text-right">
                                <a href="{{ route('website.announcement', $announcement->title) }}">بیشتر...</a>
                            </div>
                        </div>
                    </div>
                @endforeach
    ...
    <!--==========================
      Contact Section
    ============================-->
    <section id="contact" class="wow fadeInUp text-right">
        <div class="container">
            <div class="section-header">
                <h2>تماس با ما</h2>
